...
3. Follow the current phase plan. During the foundation, that is [`phase-2-implementation-plan.md`](docs/architecture/phase-2-implementation-plan.md). **Do not start a later phase's feature work.**
